...
for i in ["C", "outer_E","inner_E"]: 
  ...
  out+="\n\t\t<section zOrder=\"1\" zPosition=\""+str(-yoff[i]-p["C_dy"]/2)+"\" xOffset=\"0\" yOffset=\"0\" scalingFactor=\"0\"/>"
  out+="\n\t\t<section zOrder=\"2\" zPosition=\""+str(yoff[i]+p["C_dy"]/2)+"\" xOffset=\"0\" yOffset=\"0\" scalingFactor=\"0\"/>"
  out+="\n\t</xtru>"
