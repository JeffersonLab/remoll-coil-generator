...
clamp_1_y = [10.693, 11.354, 11.354, 12.878, 24.054, 24.054, 10.693, 10.693, 29.743, 29.743, 35.323, 48.793, 86.893, 86.893, 101.6, 101.6]

clamp_x = [[-clamp_1_x[i]+clamp_1_x[2] for i in range(0, len(clamp_1_x))],
           [-clamp_1_x[i]+clamp_1_x[2] for i in range(0, len(clamp_1_x))]]
clamp_y = [clamp_1_y,
           clamp_1_y]
clamp_rpos = [-clamp_1_x[2],
              -clamp_1_x[2]]
